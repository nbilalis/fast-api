...
# docker rm fast-api --force

# Remove any existing image with same name
# docker image rm fast-api-container
...
# docker run -d --name fast-api-instance -p 8080:5000 fast-api

# Maybe run another instance/container
# docker run -d --name fast-api-instance-2 -p 8081:5000 fast-api
